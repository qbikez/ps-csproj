...
Start-Transcript -path "c:\temp\ps-publish.log" -append


write-verbose "PSScriptRoot=$PSScriptRoot"
write-verbose "workingdir=$((get-item .).FullName)"
...
write-verbose "searching for publishmodule in: $publishModulePath"
    ...
    process{
        ...
        if(!(get-module publish-module)){
            ...
            if(Test-Path $localpublishmodulepath){
                ...
                Write-Verbose "publish-module.psm1 not found in $localpublishmodulepath"
            }
        }
    }
}
...
try{
    ...
    $publishProperties | Out-String | Write-Verbose
